...
def notion_login():
    """Redirect to Notion OAuth (placeholder - needs Notion app setup)"""
    # TODO: Replace with actual Notion OAuth URL from your Notion app
    notion_oauth_url = f"https://api.notion.com/v1/oauth/authorize?client_id=YOUR_CLIENT_ID&response_type=code&owner=user&redirect_uri=https://noted-six.vercel.app/auth/notion/callback"
